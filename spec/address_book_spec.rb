...
RSpec.describe AddressBook do
   ...
   describe "#import_from_entries_2" do
      ...
      it "imports the 1st entry" do
         ...
         check_entry(entry_two, "Alice", "555-555-4854", "alice@blocmail.com")
      end
      ...
      it "imports the 2nd entry" do
         ...
         check_entry(entry_three, "Brett", "555-555-5415", "brett@blocmail.com")
      end
      ...
      it "imports the 3rd entry" do
         ...
         check_entry(entry_four, "Chris", "555-555-3660", "chris@blocmail.com")
      end
   end
